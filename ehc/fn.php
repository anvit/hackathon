...
<?php 
 ...
 $data = mysql_query("SELECT * FROM   `type-nutrition` ") 
 or die(mysql_error()); 
 
 Print "<center><table border='0' cellpadding='2' background='images/metal-texture.jpg' id='z'>"; 
 Print "<tr><th>Type</th><th>Calories</th><th>Fat</th><th>Protein</th><th>Carbohydrates</th></tr>";
