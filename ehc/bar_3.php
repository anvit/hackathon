...
$cnt = "[";
 ...
 $data = mysql_query("SELECT  `expiry` , COUNT( * ) counter1
FROM  `transaction` 
GROUP BY  `expiry` 
HAVING  `expiry` <= DATE_ADD( CURDATE( ) , INTERVAL 30 
DAY ) 
") 
 or die(mysql_error()); 
...
$(document).ready(function(){
	var s1 = <?php print_r($cnt); ?> ;

        
    // Can specify a custom tick Array.
    // Ticks should match up one for each y value (category) in the series.
    var ticks = <?php print_r($exp); ?> ;    
